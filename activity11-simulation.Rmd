...
The mean is slightly smaller and sd is slightly larger than the 1000 sample.
...
The mean and the stan_dev are very close to each other for both sample sizes (1000 and 30).  The mean and standard deviation is farther away from each other for the 30 sample than the 1000 sample.
...
|--------------|------------|------------|
| Normal       |      64.96      |       2.12     |
| Exponential  |       2.01     |       2.14     |
| Chi-square   |       23.54     |      6.99      |
| Uniform      |     11.44       |       2.60     |
...
When the sample size is larger, the mean is much closer to the true mean.
